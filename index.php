...
<body>
    ...
    <form class="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="row">
            ...
            <input type="text"class="form-control inputst" id="firstname" name="firstname" autocomplete="off" required>
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <input type="email" class="form-control inputst" id="email" autocomplete="off" name="email" required>
...
<div class="row">
    <div class="col-sm-12 col-md-6">
        ...
        <input type="password" name="password" class="form-control inputst" id="password" name="password" required>
    </div>
    <div class="col-sm-12 col-md-6">
        <label for="cpassword" class="form-label st mt-2">Confirm Password</label>
        <input type="password" name="conformpassword" class="form-control inputst" id="cpassword" name="password" required>
    </div>
    <?php if (!empty($pass)) { ?>
